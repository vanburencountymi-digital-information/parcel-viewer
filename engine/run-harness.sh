...
"$PY" -m unittest test.run_explain_contract_test test.run_knowledge_store_test test.run_parcel_store_test test.run_pv_parcel_store_test test.run_tenant_isolation_test test.run_cost_cache_test -v
