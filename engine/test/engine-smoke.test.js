...
test('the engine modules contain no "parcel" assumption (§4.1)', () => {
  ...
  ['../capability.js', '../validate-manifest.js', '../popup.js', '../doc.js', '../app-context.js', '../selection.js', '../feature-highlight.js', '../source.js', '../manifest-version.js', '../load-manifest.js', '../manifest-assemble.js'].forEach((rel) => {
