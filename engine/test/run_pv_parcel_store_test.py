...
VBC_DICT = {
    "id": 45154,
    "parcel_no": "80-07-017-025-00",
    "county": "Van Buren",
    "municipality": "Covert Township",
    "acres": 1.0,
    "area": 43560.0,
    "computed_acres": 2.31,
    "source": "county",
    "source_file": "vbc.shp",
    "cogo_legs": None,
    "ps_legal_description": "LOT 7 ...",
    "tax_description": "TAX DESC ...",
    "created_at": None,
    "updated_at": None,
    "owner_name": "KELLY JOHN",
    "prop_street": "100 Lake St",
    "prop_city": "Covert",
    "prop_state": "MI",
    "prop_zip": "49043",
    "owner_street": "PO BOX 5",
    "owner_city": "Covert",
    "owner_state": "MI",
    "owner_zip": "49043",
    "school_dist": "Covert Public Schools",
    "prop_class": "401",
    "homestead": True,
    "qual_ag": False,
    "frontage": 80.0,
    ...
    "taxable_value": 90000,
    "prev_assessed_value": 145000,
    "prev_taxable_value": 88000,
    "assessed_value_yr0": 140000,
    "assessed_value_yr1": 138000,
    "assessed_value_yr2": 136000,
    "assessed_value_yr3": 134000,
    "assessed_value_yr4": 132000,
...
class PvParcelStoreTest(unittest.TestCase):
    ...
    def test_canonical_mapping(self):
        ...
        self.assertEqual(
            c["assessment"]["current"], {"assessed": 150000, "sev": None, "taxable": 90000}
        )
        self.assertEqual(
            c["assessment"]["detail"]["rolling"], [140000, 138000, 136000, 134000, 132000]
        )
